...
export const services: ServiceItem[] = [
  {
    ...
    summary: "Adversarial testing across web, mobile, APIs, and infrastructure to uncover exploitable risk.",
    bullets: [
  ...
  },
  {
    ...
    summary: "Rapid containment, sound forensic handling, and post-incident reviews that improve systems.",
    bullets: [
...
const slugToCategory: Record<string, (typeof serviceCategories)[number]["id"]> = {
...
export function servicesInCategory(cat: (typeof serviceCategories)[number]["id"]) {
  return services.filter((s) => slugToCategory[s.slug] === cat);
}
